...
import HangingNav from "@/components/HangingNav";
...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-zinc-50 dark:bg-zinc-900 relative overflow-hidden">
      ...
      <main className="z-10 w-full h-screen px-6 pb-12 flex flex-col items-start justify-end">
        <DrippingText text="AyuSurance" />
      </main>
    </div>
  );
}
